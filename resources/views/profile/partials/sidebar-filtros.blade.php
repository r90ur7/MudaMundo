<aside class="w-full md:w-1/4 max-w-xs md:sticky md:top-6 md:self-start bg-neutral-600 dark:bg-white rounded-2xl p-7 mb-6 md:mb-0 md:mr-8 shadow-xl flex-shrink-0 hidden md:block border border-neutral-800 dark:border-neutral-200" data-theme="dark">
    ...
    <form id="filtros-mudas-form" class="space-y-6">
        ...
        <div>
            <label for="search" class="text-sm font-semibold mb-1 text-black flex items-center gap-2">
            ...
            <input type="text" name="search" id="search" value="{{ is_array(request('search')) ? request('search')[0] : request('search') }}" class="block w-full rounded-lg border border-emerald-200 bg-white text-black focus:border-emerald-500 focus:ring-emerald-500 px-4 py-2 shadow-sm placeholder-black" placeholder="Buscar por nome ou descrição...">
        </div>
        <div>
            <label for="tipo" class="text-sm font-semibold mb-1 text-black flex items-center gap-2">
            ...
            <select id="tipo" name="tipo" class="block w-full rounded-lg border border-blue-200 bg-white text-black focus:border-blue-500 focus:ring-blue-500 px-4 py-2 shadow-sm">
...
<div class="md:hidden">
    ...
    <div id="drawerFiltros" class="fixed inset-0 z-50 bg-black/40 hidden">
        <div class="absolute left-0 top-0 h-full w-4/5 max-w-xs bg-white dark:bg-neutral-900 p-7 shadow-2xl flex flex-col rounded-r-2xl border border-neutral-200 dark:border-neutral-800">
